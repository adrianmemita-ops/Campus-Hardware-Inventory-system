...
def user_dashboard():
    ...
    return page("User dashboard", body, inventory=inventory, borrow_history=tracker.fetch_user_borrow_records(session["user_id"]), reservation_history=tracker.fetch_user_reservations(session["user_id"]))
